...
/**
 * Based on official documentation on Vuforia developers about changing the 3D Model
 * Created by Ivan on 10/13/14.
 */
public class SwitchCreature {
